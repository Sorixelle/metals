...
public interface PresentationCompilerConfig {
	...
	/**
	 * What text format to use for rendering `override def` labels for completion
	 * items.
	 */
	...
	/**
	 * Returns true if the <code>CompletionItem.detail</code> field should be
	 * populated.
	 */
	 ...
	 * <code>UserConfiguration.enableStripMarginOnTypeFormatting</code> is
	 * configured to false.
	 */
	boolean isStripMarginOnTypeFormattingEnabled();

	/**
	 * Returns true if the <code>CompletionItem.documentation</code> field should be
	 * populated.
	 */
	boolean isCompletionItemDocumentationEnabled();

	/**
	 * Returns true if the result from <code>textDocument/hover</code> should
	 * include docstrings.
	 */
	boolean isHoverDocumentationEnabled();

	/**
	 * True if the client defaults to adding the identation of the reference line
	 * that the operation started on (relevant for multiline textEdits)
	 */
	boolean snippetAutoIndent();

	/**
	 * Returns true if the <code>SignatureHelp.documentation</code> field should be
	 * populated.
	 */
  ...
  boolean isDetailIncludedInLabel();
	 ...
	 * automatically cancelled and the presentation compiler is restarted.
	 */
	long timeoutDelay();
	...
	/**
	 * The SemanticDB compiler options to use for the
	 * <code>semanticdbTextDocument</code> method.
	 *
	 * The full list of supported options is documented here
